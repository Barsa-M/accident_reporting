...
export default function ReportHistory() {
  ...
  const statusOptions = ["Resolved", "In Progress", "Pending", "Escalated"];
      ...
      prevReports.map((report) =>
        report.id === id
          ? {
              ...
              status:
                statusOptions[
                  (statusOptions.indexOf(report.status) + 1) % statusOptions.length
                ],
            }
          : report
      )
            ...
            <tr key={report.id}>
              ...
              <td className="border px-4 py-2 text-center">
                <button
                  ...
                  className="bg-[#438F64] hover:bg-[#55ad7b] text-white px-4 py-1 rounded-md"
                >
                  {report.status}
                </button>
              </td>
