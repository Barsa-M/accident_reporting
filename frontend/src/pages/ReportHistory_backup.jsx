...
export default function ReportHistory() {
  ...
  const formatLocationDisplay = (report) => {
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <div className="text-sm">
                            ...
                            {formatLocationDisplay(report).coordinates && (
                              <div className="mt-1">
                                <a
                                  href={`https://www.google.com/maps?q=${formatLocationDisplay(report).coordinates.lat},${formatLocationDisplay(report).coordinates.lng}`}
                                  target="_blank"
