    ...
    try {
      ...
      if (routingResult.success) {
        ...
        setSubmissionModal({
          isOpen: true,
          type: 'success',
          message: `Your traffic incident report has been submitted successfully and assigned to ${routingResult.responder.name}. Please check your notifications for updates.`
        });
      } else {
        ...
        setSubmissionModal({
          isOpen: true,
          type: 'success',
          message: 'Your traffic incident report has been submitted successfully. We are currently finding the best responder for you. Please check your notifications for updates.'
        });
      }
      ...
      setSubmissionModal({
        isOpen: true,
        type: 'error',
        message: 'Failed to submit your traffic incident report. Please check your connection and try again.'
      });
    } finally {
