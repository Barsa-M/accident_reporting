...
const HomePage = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "url(./assets/images/home.png)", // Background image
    ...
    >
      ...
      <div className="text-center text-white px-4 md:px-8">
        <h1 className="text-4xl font-bold mb-4">
          Safe Accident Reporting and Awareness
        </h1>
        <p className="text-lg mb-6">
          Your trusted platform for accident reports, safety tips, and more.
        </p>
